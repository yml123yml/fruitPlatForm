...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      var desc = this.desc
      axios.post('/api/allFruit/addList',{
        title:title,
        desc:desc,
        pic:pic,
        tip:tip,
        price:price,
        proDetailImg1:proDetailImg1,
        proSwipeImg1:proSwipeImg1,
        proSwipeImg2:proSwipeImg2,
        proSwipeImg3:proSwipeImg3
      }).then((response)=>{
